 ...
 */
/**
 * Elgg Admin CSS modified by Liang Lee 
 *
 * This is a distinct theme from the theme of the site. There are dependencies
 * on the HTML created by the views in Elgg core.
 *
 * @package Elgg.Core modified by Liang Lee 
 * @subpackage UI modified by Liang Lee 
 */

?>
/* LiangLee Cpanel
 * @package LiangLee Cpanel
 * @author Liang Lee
 * @copyright Copyright 2012, Liang Lee
 */
/* ***************************************
...
*************************************** */
.elgg-page-footer {
	background: #56AFD8 url(<?php echo elgg_get_site_url(); ?>mod/LiangLeePanel/media/sec_menu_bg.gif);
